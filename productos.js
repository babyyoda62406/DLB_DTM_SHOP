...
const getProduct = async () => {
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        const classList = ['text-center' ,'product-father',  'p-1', 'mt-2',  'col-12', 'col-sm-6',  'col-md-4' ,'col-lg-3' ,'col-xl-2']
        ...
        html.innerHTML = `
            ...
            <div class="  p-1  product  d-flex flex-column justify-content-between">
